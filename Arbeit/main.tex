\documentclass[ %
	DIV=14, % Parameter für die Satzspiegel-Berechnung
	BCOR=20mm, % Bindekorrektur 20mm (geeignet für Lochung oder einfache Klebebindung)
...
% --- Auswahl der Schrift-Art. Nur eine Kombination von Serif und Sans-Serif Schriften einbinden, die anderen auskommentieren!
...
% --- Charter und Source Sans Pro
\usepackage[charter]{mathdesign} % läd die Schrift Charter für den Fließtext und Mathe-Modus
\usepackage[scale=1.02]{sourcesanspro} % läd die Schrift Source Sans Pro für Überschrifen
...
\usepackage[scale=0.9]{sourcecodepro} % läd die Schrift Source Code Pro für den Quellcode-Modus
...
\usepackage{scrlayer-scrpage} % Kopf- und Fußzeilen einstellen
	...
	\begin{tikzpicture}
		\begin{loglogaxis}[
			...
			\addplot[
				...
				mark=*,
				smooth]
				table[header=false,x index=1,y index=0,meta index=3]{../Daten/#1_#2_#3.txt};
